...
public class C09_Toyota extends C08_Araba {
    ...
    // o zaman bu Toyota Class'i kendisiniden obje olusturmak icin degil
    // alt class'lari bir cati altinta toplamak icin olusturulmustur


    // -  bu class baslangic itibariyle parent'i olan
    ...
    //    parent class'daki var olan variable'lari kullabiliriz
